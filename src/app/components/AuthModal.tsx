          ...
          <div
            ...
            <div className={"p-2"}>
              ...
              <div className={"m-auto"}>
...

                {
                  loading ? (
                    <div className={" flex justify-center items-center"}>
                      <div
                        className="w-12 h-12 border-[5px] border-b-red-600 rounded-full inline-block animate-spin"></div>
                ...
                {
                  error && (
                    <div className={"bg-red-500 text-white text-sm p-2 rounded  mb-5"}>!!! {error}</div>
                  )
                }
